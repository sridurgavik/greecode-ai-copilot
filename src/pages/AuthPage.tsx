    ...
    
    {
      showVerificationUI ? (
        ...
        <div className="space-y-4">
          <button
            type="button"
            className="flex w-full items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-600 dark:hover:bg-gray-700 transition-colors duration-200 ease-in-out"
            onClick={handleGoogleLogin}
            disabled={isLoading}
          >
            {isLoading ? (
              <div className="h-4 w-4 mr-2 animate-spin rounded-full border-b-2 border-gray-700 dark:border-gray-200"></div>
            ) : (
              <svg
                ...
                <>
                  ...
                  <div className="space-y-2 mt-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <Label htmlFor="terms" className="text-sm font-normal cursor-pointer">
                        ...
                        <Button 
                          ...
                          type="button"
                          onClick={() => window.open("/resources/terms-and-conditions.html", "_blank")}
                        >
                    ...
                    <p className="text-xs text-muted-foreground">
                      By accepting, you acknowledge that Greecode is designed for mock interviews only and should not be used in actual interviews. Greecode and its team are not responsible for any legal issues arising from misuse.
                    </p>
                  </div>
                </>
              )}
